...
* [Basic](basic/README.md)
  * [사용자 인증 방법은 어떤 것들이 있는가?(작성중)](basic/undefined.md)
  * [OSI 7계층이란 무엇인가?](basic/osi-7.md)
  * [대칭키와 비대칭키 암호화 방식의 차이는?](basic/undefined-1.md)
  * [무중단 배포 방법을 알고있는가?](basic/undefined-2/README.md)
    * [A/B 테스트란 무엇인가?](basic/undefined-2/a-b.md)
  * [세션과 쿠키의 차이는?](basic/undefined-3/README.md)
    * [세션을 이용한 인증 기능을 사용할 때 서버를 다중화 한다면 문제점과 해결방안은?(Sticky Session)](basic/undefined-3/sticky-session.md)
  ...
  * [형상관리란 무엇인가?](basic/undefined-5.md)
